...
| What Noam does, feature by feature, in plain words | `references/features.md` |
| Common questions with ready-to-give answers | `references/faq.md` |

## 2. The product docs (assumed up to date)

Locate them locally by walking up to the repository containing `docs/Noam.md`.
If the repository is unavailable, ask for its current URL rather than assuming
an owner or account name.

| Topic | File |
|---|---|
| Product pitch, the core idea, stack, principles | `README.md`, `docs/Noam.md` |
...
| Installer platforms and signing | `docs/RELEASE.md` |
