...
status: draft-v1
date: 2026-07-13
tags: [thread, spec, sync, yjs, crdt, hocuspocus, bridge]
---
...
test it hard. Overview: [[00-architecture-overview]]. Storage: [[02-database-architecture]]. Index: [[Noam]].
...
supported way to use Noam — that is the whole point of the bridge. All four filesystem verbs
