...
**Context** is the permanent internal codename; **Noam** is the brand. A local-first desktop "second
...
- Docs index: `docs/Noam.md` · live build status: `docs/STATUS.md` · branding policy: `docs/BRANDING.md`
...
docs/               Noam.md (index) · STATUS.md · specs/
```
...
- Product identifier: `com.noam.app`; Tauri `productName` is "Noam".
