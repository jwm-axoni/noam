 ...
 * (case-insensitive), so `[[How Noam works]]` resolves regardless of folder.
...
export const STARTER_NOTES: ReadonlyArray<{ path: string; body: string }> = [
  {
    ...
    body: `Noam is your **local-first second brain** — notes that live as plain Markdown files on your own computer.
...
Most tools give you one of these. Noam is the bridge between all three.

## Start here

- 🧭 [[Map of Content]] — a hand-made index of everything in this vault.
- 🚀 [[How Noam works]] — a two-minute tour of the essentials.
...
`,
  ...
  // ── Getting Started ───────────────────────────────────────────────────────
  {
    path: "Getting Started/How Noam works.md",
...
Noam speaks **MCP**, so an assistant like Claude can work in your vault directly — see [[Working with your AI]].
...
Hover the left edge of a heading, a list item or a callout for a › to fold it away; Noam remembers what you folded the next time you open the note.

That's the core move behind [[Wikilinks and backlinks]]. Back to [[How Noam works]].
`,
  },
  {
    path: "Getting Started/Working with your AI.md",
    body: `Noam exposes your vault over **MCP**, so an assistant like **Claude** (in Claude Desktop or Cowork) can read and write these notes directly.
...
Good first tasks: turn your [[Ideas inbox]] into [[Atomic notes]], or draft a [[Weekly review]]. Back to [[How Noam works]].
`,
  },
  {
...
Try it on [[Meeting notes]] or a [[Website launch]] plan. Your AI joins the same way — see [[Working with your AI]]. Back to [[How Noam works]].
`,
  },
...
Syncing is additive, not a dependency: turn it on for [[Collaborating with your team]], turn it off and everything still works. This is the foundation the rest of [[How Noam works]] builds on.
`,
  },
  {
