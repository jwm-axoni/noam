...
// on :3010 (HTTP) / :3011 (Hocuspocus). Enable with NOAM_IT=1.
//
//   NOAM_IT=1 pnpm --filter desktop test -- integration
//
...
const RUN = process.env.NOAM_IT === "1";
const SERVER = process.env.NOAM_SERVER ?? "http://localhost:3010";
