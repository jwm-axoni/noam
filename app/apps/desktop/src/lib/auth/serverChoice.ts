 ...
 * - **a path prefix is kept.** Self-hosters put Noam behind a reverse proxy at
 *   e.g. `https://intranet.example.com/noam`, and stripping that would point
 ...
 *
 * Order matters: an inbound `noam://connect` link outranks everything, because
