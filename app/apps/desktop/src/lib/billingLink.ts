 ...
 * See the matching marker in app/apps/server/src/billing/. The upgrade/
 * billing UI should be removed along with the server integration once org
 * member caps are refactored off entitlements.
 */
// The `noam://billing/upgraded[?org=<orgId>]` hand-off the server's checkout
...
// platforms deliver `noam://billing/upgraded` with host "billing", others
// `noam:///billing/upgraded` with everything in the path.
