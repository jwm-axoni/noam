...
// `noam://invite/<id>` deep link that page bounces into.
//
 ...
 *
 * Not the `noam://` link, deliberately. Chat apps linkify https and leave a
 ...
 * `noam://invite/<id>` parses with host "invite" and path "/<id>", while some
 * platforms hand the same URL over as `noam:///invite/<id>` with the host
