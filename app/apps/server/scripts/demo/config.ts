...
export const demoConfig = {
   ...
   *  presence. */
  ownerEmail: env("DEMO_OWNER_EMAIL", "demo-owner@example.invalid"),
  ownerName: env("DEMO_OWNER_NAME", "Demo Owner"),
  ...
  skipEmail: env("DEMO_SKIP_EMAIL", env("DEMO_OWNER_EMAIL", "demo-owner@example.invalid")),
